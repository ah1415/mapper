...
*/
  ...
  // Connect press_menu function to the Proceed button
  GObject *menu_button = application->get_object("MenuButton");
  g_signal_connect(menu_button, "clicked", G_CALLBACK(press_menu), application);
