...
//Regular Mode Colors
static constexpr color D_BACKGROUND(240,240,240);
static constexpr color D_BUILDING(200,200,200);
static constexpr color D_STREET(255,255,255);
static constexpr color D_STREETBORDER(217,217,217);
static constexpr color D_GRASS(175,243,174);
static constexpr color D_WATER(160,217,255);
static constexpr color D_SAND(250,244,197);
static constexpr color D_HIGHWAY(255,238,156);
static constexpr color D_HIGHWAYBORDER(250,211,92);

//Night Mode Colors
static constexpr color N_BACKGROUND(56,67,82);
static constexpr color N_BUILDING(86,97,112);
static constexpr color N_STREET(76,85,98);
static constexpr color N_STREETBORDER(53,62,75);
static constexpr color N_GRASS(58,80,83);
static constexpr color N_WATER(43,58,80);
static constexpr color N_SAND(120,114,67);
static constexpr color N_HIGHWAY(136,124,105);
static constexpr color N_HIGHWAYBORDER(51,60,73);
